...
- Search Engines
   ...
   - `"r programming"` was selected because it performed best when compared
     to `"rlang"`, `"rstats"`, and `"r language"` on [Google Trends](https://trends.google.com/trends/explore?geo=US&q=rlang,rstats,r%20programming,r%20language).
- Community Sites
   - [StackOverflow Search](https://stackoverflow.com/search): `[r] + <query>`
...
These suggestions come from [Steph Locke](https://itsalocke.com/blog/) and 
